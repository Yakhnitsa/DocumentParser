...
import static main.bin.RDocEnum.*;
/**
...
public class DocumentSaver implements Saver {
    ...
    public int saveGroupToFolder(List<RailroadDocument> documents, File folder, RDocEnum... columnOrder) {
        ...
        for (RailroadDocument document : documents) {
            try {
                ...
                exceptList.append(e.getCause().toString() + " - " + e.getMessage());
            }
        }
     ...
     */
    protected Workbook getWorkbookFromRailDoc(RailroadDocument railroadDocument, RDocEnum... columnOrder) {
     ...
     */
    protected Workbook getWorkbookFromRailDocsList(List<RailroadDocument> documentList, RDocEnum... columnOrder) {
    ...
    private void setSpecifiedValueToCell(Cell cell, RailroadDocument railDoc, RDocEnum column, int vagNumb, Workbook workbook) {
        switch (column) {
            ...
            case SEND_STATION_CODE:
                ...
                break;
            case SEND_STATION_ROAD:
                cell.setCellValue(railDoc.getSendStation().getRoad());
                break;
            ...
            case RECEIVE_STATION_CODE:
                ...
                break;
            case RECEIVE_STATION_ROAD:
                cell.setCellValue(railDoc.getReceiveStation().getRoad());
                break;
            ...
            case VAGON_GROSS_WEIGHT:
                cell.setCellValue((double) railDoc.getVagonList().get(vagNumb).getGrossVeight());
                break;
            case VAGON_NET_WEIGHT:
                cell.setCellValue((double) railDoc.getVagonList().get(vagNumb).getNetVeight());
                break;
            case VAGON_TARE_WEIGTH:
                cell.setCellValue((double) railDoc.getVagonList().get(vagNumb).getTareVeight());
                break;
